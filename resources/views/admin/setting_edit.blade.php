        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li>
                        <a href="/admin/product">Setting Site</a>
                    </li>
                </ul><!-- /.breadcrumb -->
                ...
                <div class="row">
                    <div class="col-xs-12">
                        ...
                        <form enctype="multipart/form-data"
                              action="{{ route('admin_setting_update',['id'=>$data->id]) }}" method="post"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input value="{{$data->title}}" required type="text" name="title"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input value="{{$data->company}}" type="text" name="company" class="form-control"
                                           placeholder="company"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input value="{{$data->adress}}" type="text" name="adress" class="form-control"
                                           placeholder="adress"/>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="{{$data->phone}}" name="phone" class="form-control input-mask-phone"
                            ...
                            <div>
                                ...
                                <div class="input-group">
                                    ...
                                    <input value="{{$data->fax}}" name="fax" class="form-control input-mask-phone"
                                           type="text" id="form-field-mask-2"/>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input value="{{$data->smtpserver}}" type="text" name="smtpserver"
                                           class="form-control" placeholder="Smtpserver"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Smtpemail</label>
                                <div class="controls">
                                    <input value="{{$data->smtpemail}}" type="email" name="smtpemail"
                                           class="form-control" placeholder="Smtpemail"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Smtppassword</label>
                                <div class="controls">
                                    <input value="{{$data->smtpspassword}}" type="password" name="smtpspassword"
                                           class="form-control" placeholder="Smtppassword"/>
                                </div>
                            </div>
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input value="{{$data->smtpport}}" type="number" name="smtpport"
                                           class="form-control" placeholder="Smtpport"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label">Facebook</label>
                                <div class="controls">
                                    <input value="{{$data->facebook}}" required type="text" name="facebook"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input value="{{$data->twitter}}" required type="text" name="twitter"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input value="{{$data->instagram}}" required type="text" name="instagram"
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input value="{{$data->youtube}}" required type="text" name="youtube"
...
@section("js")
    ...
    <script src="{{ asset("assets/admin") }}/assets/js/chosen.jquery.min.js"></script>
    <script src="{{ asset("assets/admin") }}/assets/js/spinbox.min.js"></script>
    <script src="{{ asset("assets/admin") }}/assets/js/bootstrap-datepicker.min.js"></script>
    <script src="{{ asset("assets/admin") }}/assets/js/bootstrap-timepicker.min.js"></script>
    ...
    <script src="{{ asset("assets/admin") }}/assets/js/bootstrap-colorpicker.min.js"></script>
    <script src="{{ asset("assets/admin") }}/assets/js/jquery.knob.min.js"></script>
    <script src="{{ asset("assets/admin") }}/assets/js/autosize.min.js"></script>
    <script src="{{ asset("assets/admin") }}/assets/js/jquery.inputlimiter.min.js"></script>
    <script src="{{ asset("assets/admin") }}/assets/js/jquery.maskedinput.min.js"></script>
    <script src="{{ asset("assets/admin") }}/assets/js/bootstrap-tag.min.js"></script>
